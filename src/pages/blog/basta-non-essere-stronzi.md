...
lang: it
hasTranslation: true
customTranslationUrl: /blog/en/just-dont-be-an-asshole/
---

## I consigli sulla leadership sono ovunque, ma.
...
L'ho già scritto in [Autorità e Responsabilità](/blog/autorita-e-responsabilita/), dove l'autorità scende ma la responsabilità va verso l'alto. Un concetto così semplice che dovrebbe essere appeso sopra il monitor di ogni manager.
...
L'ho già scritto chiaramente in [Costruire un Razzo con i LEGO](/blog/costruire-un-razzo-con-i-lego/): i grandi developer - e i grandi leader - fanno scomparire la complessità invece di pavoneggiarsi con essa.

> Evita l'over-engineering / resta pragmatico.

➡️ Risolvi il problema reale, non quello nella tua testa.  
L'ho già scritto in [What Sits and What Fits](/blog/what-sits-and-what-fits/) e approfondito in [Resta nello Spazio del Problema](/blog/resta-nello-spazio-del-problema/): la chiarezza batte l'intelligenza, sempre.
...
- [La Verità sulla Test Coverage](/blog/la-verita-sulla-test-coverage/) -> la chiarezza batte le vanity metric.
- [Iterative Contract Testing](/blog/iterative-contract-testing/) -> la semplicità batte la complessità.
- [Colleague-Based Testing](/blog/colleague-based-testing/) -> il tuo codice deve essere comprensibile agli altri.
- [Asynchronous Batching](/blog/asynchronous-batching/) -> ottimizza per l'efficienza collettiva.
