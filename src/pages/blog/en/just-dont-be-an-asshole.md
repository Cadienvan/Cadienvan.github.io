...
lang: en
hasTranslation: true
customTranslationUrl: /blog/basta-non-essere-stronzi/
---
...
I already wrote this in [Authority and Accountability](/blog/en/authority-and-accountability/), where authority goes down but accountability goes up. A concept so simple it should be stapled above every manager's monitor.
...
I already wrote this clearly in [Build a Rocket with LEGOs](/blog/en/build-a-rocket-with-legos/): great developers - and great leaders - make complexity disappear instead of showing off with it.

> Avoid over-engineering / stay pragmatic.

➡️ Solve the real problem, not the one inside your head.  
I already wrote this in [What Sits and What Fits](/blog/en/what-sits-and-what-fits/) and expanded it in [Stay in the Problem Space](/blog/en/stay-in-the-problem-space/): clarity beats cleverness, always.
...
- [The Truth About Test Coverage](/blog/en/the-truth-about-test-coverage/) -> clarity beats vanity metrics.
- [Iterative Contract Testing](/blog/en/iterative-contract-testing/) -> simplicity beats complexity.
- [Colleague-Based Testing](/blog/en/colleague-based-testing/) -> your code must be understandable to others.
- [Asynchronous Batching](/blog/en/asynchronous-batching/) -> optimize for collective efficiency.
